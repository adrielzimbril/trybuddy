...
gulp.task('watch', function () {
    gulp.watch([paths.src.scss.files, paths.config.tailwind, '!' + paths.src.scss.icon], gulp.series('scss', 'browsersyncReload'))
...
gulp.task('copy:all', function () {
    return gulp
        .src([
            ...
            '!' + paths.src.js.dir, '!' + paths.src.js.files, '!' + paths.src.js.main, paths.src.js.vendors,
            '!' + paths.src.html.files,
        ])
        .pipe(gulp.dest(paths.dist.base.dir))
})
